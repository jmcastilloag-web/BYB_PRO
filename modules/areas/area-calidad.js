...
window.renderAreaCalidad = (d, i, obs) => {
    ...
    if (d.estado === 'ingresos_pendientes') {
                    UI = `<h3>Mediciones de Ingreso</h3>
                        ...
                        <div style="background:#f0f4ff;border:1px solid #c0d0f0;border-radius:6px;padding:10px;margin-bottom:10px;">
                            ...
                            <div style="display:flex;gap:6px;margin-bottom:8px;">
                                ...
                                ${window._htmlTareasLista(d,'calidad',i)}
                            </div>
                        </div>
                    ...
                    const chk = (key, label) => {
                        ...
                        const badge = m ? ' <span style="font-size:0.68em;color:#1a6ba0;background:#e8f4fd;border:1px solid #b0d4f0;border-radius:3px;padding:1px 4px;margin-left:3px;">👤 ' + m.nombre + (m.ts ? ' · ' + m.ts : '') + '</span>' : '';
                        return '<label class="det-chk-label ' + (det[key]?'det-chk-on':'') + '">'
                            + '<input type="checkbox" ' + (det[key]?'checked':'') + ' onchange="window._marcarDetalle(' + i + ',\'' + key + '\',' + (det[key]?'false':'true') + ');">'
                    ...
                    UI = `<h3>Pruebas Dinámicas</h3>
                        ...
                        <div style="background:#f0f8ff;border:1px solid #b0d4f0;border-radius:6px;padding:10px;margin-bottom:10px;">
                            ...
                            <div style="max-height:200px;overflow-y:auto;margin-bottom:10px;">
                                <table style="width:100%;border-collapse:collapse;font-size:0.82em;">
                                    ...
                                    ${window._htmlFilasTemp(d.temp_registros||[], i)}
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div style="background:#f0f4ff;border:1px solid #c0d0f0;border-radius:6px;padding:10px;margin-bottom:10px;">
                            ...
                            <div style="display:flex;gap:6px;margin-bottom:8px;">
                                ...
                                ${window._htmlTareasLista(d,'pruebas',i)}
                            </div>
                        </div>
